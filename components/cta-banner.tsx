      ...
      <div className="banco-cta-gradient overflow-hidden rounded-[2rem] border border-[#2d74b9] px-5 py-8 text-white sm:px-8 lg:px-12 lg:py-10">
        <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex w-full flex-col gap-3 sm:w-auto sm:flex-row sm:flex-wrap sm:gap-4">
            ...
            {secondary ? <Button href={secondary.href} variant="secondary" className="w-full border-white/20 bg-white/10 text-white hover:border-white/50 hover:bg-white/14 hover:text-white sm:w-auto">{secondary.label}</Button> : null}
          </div>
        </div>
      </div>
    </section>
